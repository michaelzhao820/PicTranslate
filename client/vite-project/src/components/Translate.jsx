...
const Translate = () => {
  // English are the defaults [first in the dropdowns]
  ...
  const onFileUpload = async () => {
    ...
    // Fetch the image from the imageURL ref
    const response = await fetch(imageURL.current);
    const blob = await response.blob();
    
    // Check the file type before appending to formData
            ...
            <div className="flex items-center justify-center w-full">
              <div className="flex flex-col items-center">
                <div className="relative">
                  {/*If text has been translated, output translated text. Otherwise cropping features displayed*/}
                {translatedText ? (
                ...
                <p className="pointer-none text-gray-500 "> <a  className="text-blue-600 hover:underline" onClick={() => setModalOpen(true)}>Select a file</a> from your computer</p>
                </div>
